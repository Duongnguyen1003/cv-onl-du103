    ...
    return (
        <Fragment>
            {skills.map((skill,index) =>{
                return (
                    <div key={index} className="framework-card before:right-auto w-[180px] md:w-[220px] h-[140px] md:h-[180px]">
                            <div className="space-y-2 -mt-5 md:mt-0">
                                <img className="w-[60px] h-[60px] md:w-[80px] md:h-[80px] object-center object-contain mx-auto" 
